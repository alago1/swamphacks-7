...
const Compass = (props: any) => {
    function start_compass(dest_lat: number, dest_lng: number) {
        ...
        function calcDegreeToPoint(lat1: number, lng1: number, lat2: number, lng2: number) {
    ...
    return (<div>
        ...
        <button className="start-btn" onClick={() => start_compass(props.lat, props.lng)}>Start compass</button></div>
    );
